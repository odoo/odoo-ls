...
use crate::{Sy, constants::{BuildSteps, DiagnosticLevel, OYarn}, core::{diagnostics::{DiagnosticCode, create_diagnostic}, file_mgr::FileMgr, import_resolver::create_module_from_name, odoo::SyncOdoo, symbols::{ModuleSymbol, SymbolTable, symbol_keys::{ModuleKey, NamespaceKey, SymbolKey}}}, threads::SessionInfo, utils::PathSanitizer};
...
impl ModuleSymbol {
    ...
    pub fn load_module_arch(module_key: ModuleKey, session: &mut SessionInfo, odoo_addons: NamespaceKey) {
        ...
        manifest_file_info.replace_diagnostics(DiagnosticLevel::PY_ARCH, diagnostics);
    }
