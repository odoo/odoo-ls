...
use crate::core::event::{OpenFileEvent, UpdateEvent};
...
impl LanguageServer for Backend {
    ...
    async fn did_open(&self, params: DidOpenTextDocumentParams) {
        ...
        odoo.reload_file(path, vec![TextDocumentContentChangeEvent{
            range: None,
            range_length: None,
    ...
    async fn did_change(&self, params: DidChangeTextDocumentParams) {
        ...
        odoo.reload_file(path, params.content_changes, version, false).await;
    }
...
impl Backend {
    ...
    pub async fn client_ready(&self) {
        ...
        self.event_queue.set_delay(odoo.odoo.lock().unwrap().config.auto_save_delay as u128);
    }
}
